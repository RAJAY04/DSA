public class FindInMountainArr {
    //it is a similar question to find target in rotated sorted array, rbs, but given here is we can access
    //the array only through mountainArr.get(index) method
